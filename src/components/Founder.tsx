      ...
      {isOpen && (
        <>
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 z-[100] bg-ink-900/40 backdrop-blur-xl"
          />
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 z-20 w-10 h-10 rounded-xl glass flex items-center justify-center text-ink-500 hover:text-ink-900 hover:bg-ink-100 transition-all duration-300"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="relative z-10 h-full overflow-y-auto p-8 md:p-12">
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-10 mb-16">
                  ...
                  >
                    <div>
                      <h3 className="font-display font-bold text-2xl text-ink-900 mb-4 tracking-tight">Introduction</h3>
                      <p className="text-ink-500 leading-[1.7] mb-4">
                      ...
                      <p className="text-ink-500 leading-[1.7]">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            >
              ...
              <div className="relative z-10 max-w-sm mx-auto">
                ...
                >
                  <div className="relative rounded-3xl overflow-hidden bg-mist aspect-[3/4]">
                    <img
                      src="/images/image.png"
                      alt="S. Saktheeswaran — Founder & Managing Director of Astra Nexora"
                      className="absolute inset-0 w-full h-full object-cover"
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-ink-500">Business Administration</div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-ink-500">End-to-End Expertise</div>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            >
              ...
              <motion.h2
                ...
                className="font-display font-bold text-4xl md:text-5xl text-ink-900 mb-7 leading-[1.1] tracking-tight"
              >
                The Vision
                <br />
